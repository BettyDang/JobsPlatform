...
//           this.errorMessage = 'You are not authorized to view this job';
//         } else {
//           this.errorMessage = 'An error occured while fetching job details';
//         }
//       }
//     });
//   } 
...
//         const proposalsWithId = data.map( p => ({
//           ...p,
//           id: p.id || ( p as any)._id
//         }));
...
//         if(this.isOwner) 
//           this.proposals = proposalsWithId;
//         else this.proposals = proposalsWithId.filter( p => p.freelancer.id === this.currentUserId);
//       },
//       error: (err) => 
...
//     this.proposalService.submitProposal(this.job.id, this.price, this.coverLetter || undefined, this.message || undefined).subscribe({
//       next: () => {
//         alert("Proposal submitted successfully");
...
//     this.proposalService.withdrawProposal(proposalId).subscribe({
//       next: () => {
//         alert('Proposal withdrawn');
//         this.loadProposals();
//       },
